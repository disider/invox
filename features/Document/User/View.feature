Feature: User views a document
  ...
  Background:
    ...
    And there is a company:
      | name | address         | vatNumber  | owner            | template     |
      | Acme | Company address | 0123456789 | user@example.com | AcmeTemplate |
  ...
  Scenario: I can view translated document details
    When I visit "/documents/%documents.D02.id%/render?showAsHtml=true"
    Then I should see the "document" details:
      | document-ref | D02/14 del 01/01/2014 |
