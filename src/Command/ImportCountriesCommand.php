...
class ImportCountriesCommand extends Command
{
    ...
    protected function importCountryCodes($path, OutputInterface $output)
    {
        ...
        $this->dump($path.'/00-countries.yml', Country::class, $codes);
    ...
    protected function importCountryNames($locale, $path, OutputInterface $output)
    {
        ...
        $this->dump(sprintf('%s/05-countries-%s.yml', $path, $locale), CountryTranslation::class, $translations);
    }
