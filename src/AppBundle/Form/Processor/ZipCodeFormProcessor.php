...
use AppBundle\Form\ZipCodeForm;
...
{
    public function __construct(ZipCodeRepository $repository, FormFactoryInterface $formFactory, TokenStorageInterface $tokenStorage)
    {
